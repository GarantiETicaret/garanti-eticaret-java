		...
		*/
		...
		Sale3DOOSPayRequest sale3DOOSPayRequest = new Sale3DOOSPayRequest();  
            ...
            sale3DOOSPayRequest.refreshtime = "5";
               ...
               String form = Sale3DOOSPayRequest.execute(sale3DOOSPayRequest,settings3D); //"Tarih aralýðý ile Ýþlem Sorgulama servisi baþlatýlmasý için gerekli servis çaðýrýsýný temsil eder."
               		out.println(form);
