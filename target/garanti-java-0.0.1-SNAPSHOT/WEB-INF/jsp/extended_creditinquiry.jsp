...
<fieldset>
    ...
    <label style="font-weight:bold;">Servis Adý &nbsp; :   &nbsp; </label> extendedcreditinq<br>
	...
	if ("POST".equalsIgnoreCase(request.getMethod())) {
		...
		*/
		...
		extendedCreditInquiryRequest.Terminal=new Terminal();
               ...
               String extendedCreditInquiryResponse = ExtendedCreditInquiryRequest.execute(extendedCreditInquiryRequest,settings); //"Tüketici Kredisi Sorgulama servisi baþlatýlmasý için gerekli servis çaðýrýsýný temsil eder."
               StringWriter sw = new StringWriter();
               JAXB.marshal(extendedCreditInquiryResponse, sw);
               out.println("<pre>" + Helper.prettyPrintXml(sw.toString()) + "</pre>"); //"Tüketici Kredisi Sorgulama servis çaðrýsý sonucunda oluþan servis çýktý parametrelerinin ekranda gösterilmesini saðlar"
	}
%>
