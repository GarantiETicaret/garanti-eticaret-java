...
public class CommercialCardExtendedCreditRequest extends VPOSRequest
{
    
    
    public static String execute(CommercialCardExtendedCreditRequest request, Settings settings) throws Exception 
    {  
