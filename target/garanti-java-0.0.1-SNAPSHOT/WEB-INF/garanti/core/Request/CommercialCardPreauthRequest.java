...
public class CommercialCardPreauthRequest extends VPOSRequest
{
    
    
    public static String execute(CommercialCardPreauthRequest request, Settings settings) throws Exception 
    {  
