...
public class ExtendedCreditInquiryRequest extends VPOSRequest
{
   
    
    public static String execute(ExtendedCreditInquiryRequest request, Settings settings) throws Exception 
    {  
