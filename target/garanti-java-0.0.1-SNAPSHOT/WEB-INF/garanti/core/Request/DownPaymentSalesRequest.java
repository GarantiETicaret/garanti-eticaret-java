...
public class DownPaymentSalesRequest extends VPOSRequest
{
    
    
    public static String execute(DownPaymentSalesRequest request, Settings settings) throws Exception 
    {  
