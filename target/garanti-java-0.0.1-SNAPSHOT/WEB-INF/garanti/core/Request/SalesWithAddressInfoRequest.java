...
public class SalesWithAddressInfoRequest extends VPOSRequest
{
    
    public static String execute(SalesWithAddressInfoRequest request, Settings settings) throws Exception 
    {  
