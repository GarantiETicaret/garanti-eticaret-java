...
public class CommercialCardLimitInqRequest extends VPOSRequest
{
   
    
    public static String execute(CommercialCardLimitInqRequest request, Settings settings) throws Exception 
    {  
