...
public class UtilityPaymentInqRequest extends VPOSRequest
{
   
    
   
    
    public static String execute(UtilityPaymentInqRequest request, Settings settings) throws Exception 
    {  
