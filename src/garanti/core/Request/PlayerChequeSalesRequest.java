...
public class PlayerChequeSalesRequest extends VPOSRequest
{
    
    
    public static String execute(PlayerChequeSalesRequest request, Settings settings) throws Exception 
    {  
