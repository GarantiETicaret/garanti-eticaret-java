...
public class SalesWithProductInfoRequest extends VPOSRequest
{
     
    
    public static String execute(SalesWithProductInfoRequest request, Settings settings) throws Exception 
    {  
